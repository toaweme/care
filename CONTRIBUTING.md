...
Thanks for your interest in improving `care`. This project uses an **issue-first**
...
`care` is a CLI application.

```sh
go build -o bin/care ./cmd/care   # build the binary
./bin/care --version              # confirm the build
go test ./...                     # run the tests
```

When you report a bug, please include the output of `care --version`, your OS and
